...
#oefening getcomponent en colliders
![alt text](HealthPickup.gif)
![player script](<Prog M5/Assets/scripts/PlayerMovement.cs>)
![Health pickup](<Prog M5/Assets/scripts/HealthPickup.cs>)
heb geoefend met getcomponent en colliders en if else